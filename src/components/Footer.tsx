export default function Footer() {
  ...
  return (
    <footer className="border-t border-white/20 bg-gradient-to-r from-white/8 via-white/6 to-white/8 backdrop-blur-sm py-4 text-center text-sm text-muted-foreground">
